  ...
  [5935],
  {
          ...
          switch ((h && h[1] && (c = h[1].toLowerCase()), c)) {
            case t:
              return (
                (u = s(e)),
                i.test(e) ||
                  ((d = u.querySelector(n)) && d.parentNode.removeChild(d)),
                a.test(e) ||
            ...
            case r:
              return (
                (f = (u = l(e)).querySelectorAll(c)),
                a.test(e) && i.test(e) ? f[0].parentNode.childNodes : f
              );
            default:
              return p ? p(e) : (d = l(e, r).querySelector(r)).childNodes;
          }
        });
    },
    ...
    1507: function (e, t, n) {
      for (
        var r,
          o = n(47915),
          i = n(60885).CASE_SENSITIVE_TAG_NAMES,
          a = o.Comment,
          l = o.Element,
      ...
      t.e = function e(t, n, r) {
        ...
        for (var o = [], i = 0, u = t.length; i < u; i++) {
          ...
          switch (d.nodeType) {
            case 1:
              (p = new l(h(d.nodeName), f(d.attributes))).children = e(
                d.childNodes,
                p
              );
              break;
    ...
    50484: function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        for (t in e)
          ...
          else if ((l = i((n = t.toLowerCase()))))
            switch (
              ((s = r.getPropertyInfo(l)),
              ("checked" !== l && "value" !== l) || u || (l = i("default" + n)),
              (c[l] = a),
              s && s.type)
            ) {
              case r.BOOLEAN:
    ...
    53670: function (e, t, n) {
      ...
      e.exports = function e(t, n) {
        for (
          ...
          if (((i = t[x]), v && y((u = n.replace(i)))))
            k > 1 && (u = h(u, { key: u.key || x })), g.push(u);
          else if ("text" !== i.type) {
            switch (
              ((p = i.attribs),
              s(i) ? a(p.style, p) : p && (p = o(p)),
              (d = null),
              i.type)
            ) {
              case "script":
              case "style":
                i.children[0] &&
                  (p.dangerouslySetInnerHTML = { __html: i.children[0].data });
                break;
              case "tag":
                "textarea" === i.name && i.children[0]
                  ? (p.defaultValue = i.children[0].data)
                  : i.children && i.children.length && (d = e(i.children, n));
                break;
              default:
                continue;
            }
            k > 1 && (p.key = x), g.push(m(i.name, p, d));
          } else {
            if ((c = !i.data.trim().length) && i.parent && !l(i.parent))
              continue;
            if (b && c) continue;
            g.push(i.data);
          }
      ...
      e.exports = function (e, s) {
        ...
        function w() {
          var e = h(),
            n = v(o);
          if (n) {
            if ((k(), !v(i))) return g("property missing ':'");
            var r = v(a),
              s = e({
                type: "declaration",
    ...
    57848: function (e, t, n) {
      ...
      e.exports = function (e, t) {
        ...
        for (
          var i, a, l = r(e), s = "function" === typeof t, c = 0, u = l.length;
          c < u;
          c++
        )
          (i = (n = l[c]).property),
            (a = n.value),
            s ? t(i, a, n) : a && (o || (o = {}), (o[i] = a));
        return o;
      };
    },
    25935: function (e, t, n) {
      ...
      var r = n(30488),
        o = (r.domToReact, r.htmlToDOM, r.attributesToProps, r.Element);
      t.ZP = r;
    },
  },
]);
